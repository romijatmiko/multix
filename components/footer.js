				...
				<div class="sm:col-span-2">
					...
					<div class="mt-6 lg:max-w-sm">
						<p class="text-sm text-gray-800">
							...
							The company is dedicated to creating tools that make everyday life
							easier through advanced multimedia technology.
						</p>
						<p class="mt-4 text-sm text-gray-800">
							At Multix, we understand the power of multimedia in enhancing
							various aspects of life. Our team of experts is committed to
							staying at the forefront of technological advancements,
							continuously innovating and improving our products to meet the
